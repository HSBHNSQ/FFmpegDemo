...
#CONFIGURE_FLAGS="--enable-cross-compile --enable-gpl --disable-debug --disable-programs \
#                 --disable-doc --enable-pic"


CONFIGURE_FLAGS="--enable-static --enable-swscale --enable-nonfree --enable-gpl \
                --disable-debug --enable-shared --disable-programs \
                --disable-doc --enable-pic --enable-cross-compile"
